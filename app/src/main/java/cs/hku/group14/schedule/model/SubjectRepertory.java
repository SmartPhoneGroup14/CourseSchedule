...
//    public static List<ClassEntity> loadDefaultSubjects() {
//        //json转义
...
//    }
//
//    public static List<ClassEntity> loadDefaultSubjects2() {
//        //json转义
...
//                if (array2.length() <= 10) {
//                    courses.add(new ClassEntity(term, name, null, teacher, null, -1, -1, -1, -1, null));
//                    continue;
//                }
...
//                    step = -1;
//                }
//                courses.add(new ClassEntity(term, name, room, teacher, getWeekList(weeks), start, step, day, -1, null));
//            }
