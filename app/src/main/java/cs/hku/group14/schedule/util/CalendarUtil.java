...
public class CalendarUtil {
    ...
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.group14";
    ...
    public static boolean addCalendarEvent(Context context, String title, String description, long beginTime) {
        ...
        mCalendar.setTimeInMillis(start + 3600);//设置终止时间
    ...
    public static void deleteCalendarEvent(Context context, String title) {
        Cursor eventCursor = context.getContentResolver()
                .query(Uri.parse(CALANDER_EVENT_URL), null, null, null, null);
        try {
